	    	...
	    	buttons: [
	    		{
					...
					handler:function(){
						...
						if(!validate){
                            ...
                            var sn = $("#add_sn").textbox("getText");
							var phone = $("#add_phone").textbox("getText");
							var qq = $("#add_qq").textbox("getText");
							var password = $("#add_password").textbox("getText");
							var data = {clazzid:clazzid, name:name,sex:sex,mobile:phone,qq:qq,password:password,sn:sn};
	    	...
	    	buttons: [
	    		{
					...
					handler:function(){
						...
						if(!validate){
                            ...
                            var sn = $("#edit_sn").textbox("getText");
							var data = {id:id, clazzid:clazzid, name:name,sex:sex,mobile:phone,qq:qq,sn:sn};
	...
	<div id="addDialog" style="padding: 10px;">  
   		...
   		<form id="addForm" method="post">
	    	<table id="addTable" border=0 style="width:800px; table-layout:fixed;" cellpadding="6" >
				...
				<tr>
					<td>工号:</td>
					<td colspan="4"><input id="add_sn" style="width: 200px; height: 30px;" class="easyui-textbox" type="text" name="sn" validType="number" /></td>
				</tr>
	    	</table>
	    </form>
	</div>
	...
	<div id="editDialog" style="padding: 10px">
    	...
    	<form id="editForm" method="post">
	    	<table id="editTable" border=0 style="width:800px; table-layout:fixed;" cellpadding="6" >
				...
				<tr>
					<td>工号:</td>
					<td colspan="4"><input id="edit_sn" style="width: 200px; height: 30px;" class="easyui-textbox" type="text" name="sn" validType="number" /></td>
				</tr>
	    	</table>
	    </form>
	</div>
