...
<div id="addDialog" style="padding: 10px">
	...
	<form id="addForm" method="post">
		<table cellpadding="8" >
			...
			<tr>
				<td>学号:</td>
				<td><input id="add_sn" style="width: 200px; height: 30px;" class="easyui-textbox" name="sn" /></td>
			</tr>
		</table>
	</form>
</div>
...
<div id="editDialog" style="padding: 10px">
	...
	<form id="editForm" method="post">
		...
		<table cellpadding="8" >
			...
			<tr>
				<td>学号:</td>
				<td><input id="edit_sn" style="width: 200px; height: 30px;" class="easyui-textbox" name="sn" /></td>
			</tr>
		</table>
	</form>
</div>
	...
	<div id="addDialog" style="padding: 10px">  
    	...
    	<form id="addForm" method="post">
	    	<table cellpadding="8" >
	    		...
	    		<tr>
	    			<td>电话:</td>
	    			<td><input id="add_phone" style="width: 200px; height: 30px;" class="easyui-textbox" type="text" name="tel" validType="mobile" /></td>
	    		</tr>
	    		<tr>
	    			<td>QQ:</td>
	    			<td><input id="add_qq" style="width: 200px; height: 30px;" class="easyui-textbox" type="text" name="qq" validType="number" /></td>
	...
	<div id="editDialog" style="padding: 10px">
    	...
    	<form id="editForm" method="post">
	    	<table cellpadding="8" >
	    		...
	    		<tr>
	    			<td>电话:</td>
	    			<td><input id="edit_phone" style="width: 200px; height: 30px;" class="easyui-textbox" type="text" name="tel" validType="mobile" /></td>
	    		</tr>
	    		<tr>
	    			<td>QQ:</td>
	    			<td><input id="edit_qq" style="width: 200px; height: 30px;" class="easyui-textbox" type="text" name="qq" validType="number" /></td>
